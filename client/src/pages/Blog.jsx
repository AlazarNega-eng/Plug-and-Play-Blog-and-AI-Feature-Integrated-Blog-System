    ...
    <div>
      <div className='relative'>
        ...
        <div className='text-center mt-20 text-gray-600'>
          ...
          <h1 className='text-2xl font-semibold sm:text-5xl max-w-2xl mx-auto text-gray-800/90'>{data.title}</h1>
      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
          <input onChange={(e) => setName(e.target.value)} value={name} type="text" placeholder='Name' required className='w-full p-2 border border-gray-300 rounded-md outline-none'/>
          <textarea onChange={(e) => setContent(e.target.value)} value={content} placeholder='Comment' required className='w-full p-2 border border-gray-300 rounded-md outline-none h-48'/>
